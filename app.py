...
Original file is located at
    https://colab.research.google.com/drive/12MSYMUk4l5UhZ09n6YDP9wLgQYFXjK-d
"""
...
with open('/content/model/index2auth.pickle','rb') as file:
  index2auth=pickle.load(file)

with open('/content/model/venue_fullforms','rb') as file:
  venue_fullforms=pickle.load(file)

with open('/content/model/url_author','rb') as file:
...
def login():
    ...
    path_to_trained_model = '/content/model/combined_ambig_references_model.h5'
